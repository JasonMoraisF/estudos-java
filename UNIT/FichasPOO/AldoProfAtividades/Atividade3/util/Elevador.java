package UNIT.FichasPOO.AldoProfAtividades.Atividade3.util;
...
public class Elevador {
    ...
    public int getPessoasTransportadas() {return pessoasTransportadas;}

    public int getLimitePessoas() {return limitePessoas;}

    public String getStatus() {return status;}

	public int consultaPessoasTransportadas() {return this.pessoasTransportadas;}
